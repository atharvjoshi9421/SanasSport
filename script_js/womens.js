 ...
 navItems.forEach(item => {
    ...
    link.addEventListener('click', (e) => {
        ...
        // 1. Women's Hero Animation - Elegant fade and gentle slide
        const heroTimeline = gsap.timeline();
        heroTimeline.from(".gsap-w-hero", { y: 40, opacity: 0, backdropFilter: "blur(0px)", duration: 1.5, ease: "power3.out" })
                    .from(".gsap-w-hero-sub .w-filter", { y: 20, opacity: 0, duration: 0.8, stagger: 0.1, ease: "power2.out" }, "-=0.8");

        // 2. Elegant Product Grid Reveal - Soft upward float
        ScrollTrigger.batch(".gsap-w-card", {
