  /* =========================================
        ...
        // 1. Shoes Hero Animation
        const heroTimeline = gsap.timeline();
        heroTimeline.from(".hero-bg-text", { scale: 1.5, opacity: 0, duration: 2, ease: "power3.out" })
                    .from(".gsap-hero-title", { y: 50, opacity: 0, duration: 1, ease: "power4.out" }, "-=1.5")
                    .from(".gsap-hero-subtitle", { y: 30, opacity: 0, duration: 1, ease: "power3.out" }, "-=1.2")
                    .from(".gsap-filters", { y: 20, opacity: 0, duration: 0.8 }, "-=0.8");

        // 2. Parallax effect on the background text
