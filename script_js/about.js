    ...
    link.addEventListener('click', (e) => {
        ...
        // 1. Hero Section Animations (Plays immediately on load)
        const heroTimeline = gsap.timeline();
        heroTimeline.from(".gsap-hero-title", { 
            y: 80, 
            opacity: 0, 
            duration: 1.2, 
            ease: "power4.out" 
        ...
        // 2. Elements sliding in from the left
        ...
        // 3. Elements sliding in from the right
        ...
        // 5. General Fade-up for the bottom section
